    ...
    public class InMemoryProductDal : IProductDal
    {
        ...
        public InMemoryProductDal()
        {
            _products = new List<Product> {
                ...
                new Product{ProductId = 1,CategoryId = 2,ProductName = "Phone",UnitPrice = 1500,UnitsInStock = 2},
                new Product{ProductId = 1,CategoryId = 2,ProductName = "Keyboard",UnitPrice = 150,UnitsInStock = 65},
                new Product{ProductId = 1,CategoryId = 2,ProductName = "Mouse",UnitPrice = 80,UnitsInStock = 1},
